...
public class vp_FPBodyAnimator : vp_BodyAnimator
{
	...
	public UnityEngine.Material InvisibleMaterial = null;					// this should be set to an invisible, shadow casting material. see the included 'InvisibleShadowCaster' shader & material
	protected UnityEngine.Material[] m_FirstPersonMaterials;
	protected UnityEngine.Material[] m_FirstPersonWithArmsMaterials;
	protected UnityEngine.Material[] m_ThirdPersonMaterials;
	protected UnityEngine.Material[] m_InvisiblePersonMaterials;
	...
	protected virtual void InitMaterials()
	{
		...
		this.m_FirstPersonMaterials = new UnityEngine.Material[Renderer.materials.Length];
		this.m_FirstPersonWithArmsMaterials = new UnityEngine.Material[Renderer.materials.Length];
		this.m_ThirdPersonMaterials = new UnityEngine.Material[Renderer.materials.Length];
		this.m_InvisiblePersonMaterials = new UnityEngine.Material[Renderer.materials.Length];
